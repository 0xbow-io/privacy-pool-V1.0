...
contract FixedPointMathLibTest is SoladyTest {
    ...
    function testSqrtWad() public {
        ...
        assertEq(FixedPointMathLib.sqrtWad(type(uint256).max), 340282366920938463463374607431768211455000000000);
    }
    ...
    function testCbrtWad() public {
        ...
        assertEq(FixedPointMathLib.cbrtWad(type(uint256).max), 48740834812604276470692694000000000000);
    }
