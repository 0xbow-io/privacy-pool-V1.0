...
import { ZkCircuit, Groth16Circuit } from '@core/pool/models';
import { hashLeftRight } from 'maci-crypto';
import { Address, PublicClient, WalletClient } from 'viem';
import { PrivateInputs, PublicInputs, CommitmentSignals } from '@core/pool/types';
...
export type Pool = State & View & Chain & ZkCircuit;

export class PrivacyPool extends Groth16Circuit implements Pool {
