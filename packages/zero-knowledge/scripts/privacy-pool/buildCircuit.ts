...
await PrivacyPool.build_artifacts().then((paths) => {
  ...
  moveFileIfExists(`${outDir}/groth16_vkey.json`, `packages/webapp/public/artifacts`)
  moveFileIfExists(`${outDir}/groth16_pkey.zkey`, `packages/webapp/public/artifacts`)
  moveFileIfExists(`${outDir}/${circuitName}_js/${circuitName}.wasm`, `packages/webapp/public/artifacts`)
